...
export default function CambiosEntradaPage() {
    const { state, refreshHistorialEntradas } = useCallao();
    ...
    const actasPorMovimiento = useActasPorMovimiento('entrada');
    ...
    }, [state.cambiosEntrada, actasPorMovimiento]);
    ...
    const handleExportExcel = () => {
        ...
        exportToExcel(exportRows, columns, `Cambios_Entrada_${new Date().toISOString().split('T')[0]}`);
    };
    ...
    const handleExportPDF = () => {
        ...
        exportToPDF(exportRows, columns, `Cambios_Entrada_${new Date().toISOString().split('T')[0]}`, 'Cambios de Entrada');
    };
                                            ...
                                            >
                                                ...
                                                <div className="hidden sm:flex items-center gap-4 text-[10px] text-gray-600 whitespace-nowrap flex-shrink-0">
                                                    ...
                                                    <span className="inline-flex items-center gap-2">
                                                        ...
                                                        <span className="font-bold text-gray-900">{motivosTotales}</span> motivos
                                                    </span>
                                                </div>
                                            </div>
