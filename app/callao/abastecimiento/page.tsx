            ...
            if (descargarPDFDespues) {
                ...
                if (productosSI.length > 0) {
                    ...
                    const datosPDF = productosSI.map(row => ({
                        ...
                        smp1: row.tiendas['TIENDA SMP-1'],
                        smp2: row.tiendas['TIENDA SMP-2'],
                    ...
                    const columns = [
                        ...
                        { header: 'SMP-1', dataKey: 'smp1' },
                        { header: 'SMP-2', dataKey: 'smp2' },
                ...
                const rowsCalculados: AbastecimientoRow[] = abastecimientoData.map(item => {
                    ...
                    return {
                        ...
                        tiendas: {
                            ...
                            'TIENDA OFICINA-DOCENAS': item.abastecer_oficina_docenas ?? 0,
                            'TIENDA CALLAO-1-A': item.abastecer_callao1a ?? 0,
                            'TIENDA CALLAO-1-B': item.abastecer_callao1b ?? 0,
                            'TIENDA SMP-1': item.abastecer_smp1 ?? 0,
                            'TIENDA SMP-2': item.abastecer_smp2 ?? 0,
                        },
