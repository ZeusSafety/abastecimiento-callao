...
function ModalEntrada({
    ...
    const handleSubmit = async () => {
        if (isEdit) {
            ...
            // Requerimiento: siempre solicitar contraseña antes de guardar (haya o no actas).
    ...
    return (
        <>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <PrettySelect
                                    ...
                                    options={OPS_ENTRADA.map(op => ({ value: op, label: op }))}
                                    size="sm"
                                />
                            </div>
                                                                    ...
                                                                    <td className="px-3 py-2">
                                                                        {isEditing ? (
                                                                            <div className="min-w-[108px]" onClick={e => e.stopPropagation()}>
                                                                                <PrettySelect
                                                                                    value={p.operacion}
                                                                                    onChange={v => handleActualizarProducto(index, 'operacion', v)}
                                                                                    options={OPS_ENTRADA.map(op => ({ value: op, label: op }))}
                                                                                    portal
                                                                                    portalZIndex={28000}
                                                                                />
                                                                        ...
                                                                        {isEditing ? (
                                                                            <div className="min-w-[132px]" onClick={e => e.stopPropagation()}>
                                                                                <PrettySelect
                                                                                    ...
                                                                                    onChange={v => handleActualizarProducto(index, 'almacenSalida', v)}
                                                                                    options={ORIGENES_ALMACEN_SALIDA_ENTRADA_CALLAO.map(({ value, label }) => ({
                                                                                        value,
                                                                                        label,
                                                                                    }))}
                                                                        ...
                                                                        {isEditing ? (
                                                                            <div className="min-w-[128px]" onClick={e => e.stopPropagation()}>
                                                                                <PrettySelect
                                                                                    ...
                                                                                    onChange={v => handleActualizarProducto(index, 'almacenIngreso', v)}
                                                                                    options={TIENDAS_ETIQUETA_MOVIMIENTOS_CALLAO.map(({ tienda, label }) => ({
                                                                                        value: tienda,
                                                                                        label,
                                                                                    }))}
            ...
            {/* Modal Contraseña (siempre al guardar) */}
                    ...
                    <div className="modal-box" style={{ maxWidth: 520, width: '90vw', zIndex: 20011 }}>
                        <div className="modal-header">
                            <div>
                                ...
                                <p style={{ margin: 0, fontSize: 11, color: '#6b7280' }}>
                                    Para proceder con el guardado, ingrese la contraseña de autorización
                                </p>
                            </div>
                            <button
                                onClick={() => {
