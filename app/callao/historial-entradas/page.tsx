            ...
            <div className="modal-box" style={{ maxWidth: 680, background: 'white', borderRadius: 16, padding: 0, overflow: 'hidden' }}>
                ...
                <div className="modal-body" style={{ padding: 20, maxHeight: '70vh', overflowY: 'auto' }}>
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="form-label" style={{ fontSize: 11, fontWeight: 600, color: '#64748b', display: 'block', marginBottom: 4 }}>Registrado por</label>
                            <select
...
export default function HistorialEntradasPage() {
    ...
    const [pendingUpdates, setPendingUpdates] = useState<Record<string, { data: Partial<RegistroEntrada>; motivo: string }>>({});
    ...
    const [cargaPendientePassword, setCargaPendientePassword] = useState<api.EntradaCascadaDB | null>(null);
    ...
    const ejecutarActualizacionCarga = async (carga: api.EntradaCascadaDB, pendientes: string[]) => {
        try {
            ...
            for (const id of pendientes) {
                ...
                await updateEntrada(id, upd.data, upd.motivo);
            }
            await Promise.all([refreshEntradas(), refreshHistorialEntradas(), refreshCargas()]);
    ...
    const aplicarActualizacionCarga = async (carga: api.EntradaCascadaDB) => {
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4 mb-2 bg-transparent">
                            ...
                            <div className="flex items-center gap-3 w-full sm:w-auto">
                                <div className="relative flex-1 sm:w-72">
                                    ...
                                    <input
                                        type="text"
                                        name="buscar_historial_entradas"
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-xl">
                            <div className="divide-y divide-gray-100">
                                ...
                                paginatedCargas.map((carga, idx) => {
                                        ...
                                        const movimiento = `${detalleRep?.tienda_salida_codigo || '-'} → ${detalleRep?.tienda_ingreso_codigo || '-'}`;
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <td className="px-4 py-3">
                                                                                        <button
                                                                                            type="button"
                                                                                            onClick={() => {
                                                                                                const entradaParaEditar =
                                                                                                    state.entradas.find(en => en.id === String(d.id)) || null;
                                                                                                if (entradaParaEditar) openEdit(entradaParaEditar);
                                                                                            }}
                            ...
                            <div className="mb-6">
                                ...
                                <div className="border-2 border-dashed border-[#002D5A]/30 rounded-xl p-4 text-center hover:border-[#002D5A]/50 transition-colors bg-[#002D5A]/5">
                                    <input
                                        ...
                                        className="hidden"
                                        id="file-input-actas-subir-entradas"
                                    />
                                    <label
                                        htmlFor="file-input-actas-subir-entradas"
