                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {paginated.map((c, i) => (
                                        <tr key={`${c.id}-${i}`} className="hover:bg-blue-50/30 transition-colors">
                                            ...
                                            <td className="px-4 py-3 text-[11px] text-gray-600 uppercase italic">{c.comprobante || '-'}</td>
                                            <td className="px-4 py-3 text-[11px] text-gray-600 uppercase">{c.asesor || '-'}</td>
                                            ...
                                            <td className="px-4 py-3 text-[11px] font-medium text-[#002D5A] uppercase">{c.almacen}</td>
