    ...
    try:
        for idx, entrada_data in enumerate(entradas):
            try:
                ...
                if not tienda_ingreso_id:
                    errores.append(f"Entrada {idx + 1}: Tienda de ingreso no encontrada")
                    continue
    ...
    try:
        sql = """
            SELECT 
                ...
                ce.operador, ce.cantidad, ce.cantidad_anterior, um.nombre as unidad_medida,
    ...
    try:
        sql = """
            SELECT 
                ...
                cs.cantidad, cs.cantidad_anterior, um.nombre as unidad_medida,
